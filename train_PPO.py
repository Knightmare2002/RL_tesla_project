...
CHECKPOINT_DIR = "C:\\Users\\samue\\OneDrive\\Desktop\\MLDL\\RL_tesla_project\\checkpoint_dir\\SacModel4"
...
try:
    model = PPO(MlpPolicy, env, verbose=1, device='cuda', tensorboard_log="./tb_logs/")
